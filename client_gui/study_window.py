...
#    Jun 28, 2021 09:36:07 PM CEST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1(root)
    study_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, conn, study, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_Toplevel1(root, *args, **kwargs)' .'''
    global w, w_win, root, connection, study1
    # rt = root
    root = rt
    w = tk.Toplevel(root)
    top = Toplevel1(w)
    connection = conn
    study1 = study
    study_window_support.init(w, top, connection, study1, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.configure(text='''Study''')
        ...
        self.Label2.configure(text='''study_id''')
        ...
        self.Label3.configure(text='''StudyInstanceUID''')
        ...
        self.Label4.configure(text='''patient_id''')
        ...
        self.Label5.configure(text='''StudyDate''')
        ...
        self.Label6.configure(text='''StudyDescription''')
        ...
        self.Label7.configure(text='''StudyID''')
        ...
        self.Scrolledwindow1.place(relx=0.051, rely=0.553, relheight=0.414
                                   , relwidth=0.905)
        ...
        self.Label8.place(relx=0.051, rely=0.486, height=33, width=698)
        ...
        self.Label8.configure(text='''Study Series''')
        ...
        self.Label9.configure(text='''StudyIDIssuer''')

        self.Label10 = tk.Label(top)
        self.Label10.place(relx=0.026, rely=0.436, height=21, width=115)
        ...
        self.Label10.configure(text='''StudyTime''')
        ...
        self.Text8.place(relx=0.23, rely=0.436, relheight=0.04, relwidth=0.542)
        ...
        self.Button1.place(relx=0.793, rely=0.084, height=24, width=137)
        ...
        self.Button1.configure(command=study_window_support.generate_report)
