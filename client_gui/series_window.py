...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label6.configure(text='''SeriesNumber''')
        ...
        self.Label7.configure(text='''SeriesDescription''')
        ...
        self.Button1.place(relx=0.793, rely=0.084, height=24, width=147)
        ...
        self.Button1.configure(command=series_window_support.generate_report)
