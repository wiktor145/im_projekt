...
#    Jun 28, 2021 09:16:26 PM CEST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1(root)
    image_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, conn, imagefile, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_Toplevel1(root, *args, **kwargs)' .'''
    global w, w_win, root, connection, image
    # rt = root
    root = rt
    w = tk.Toplevel(root)
    top = Toplevel1(w)
    connection = conn
    image = imagefile
    image_window_support.init(w, top, connection, image, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.0, rely=0.0, height=45, width=876)
        ...
        self.Label2.place(relx=0.027, rely=0.083, height=22, width=135)
        ...
        self.Label2.configure(text='''image_id''')

        self.Label3 = tk.Label(top)
        self.Label3.place(relx=0.027, rely=0.134, height=26, width=135)
        ...
        self.Label3.configure(text='''series_id''')

        self.Label4 = tk.Label(top)
        self.Label4.place(relx=0.027, rely=0.184, height=25, width=132)
        ...
        self.Label4.configure(text='''file_id''')

        self.Label5 = tk.Label(top)
        self.Label5.place(relx=0.027, rely=0.235, height=25, width=132)
        ...
        self.Label5.configure(text='''file_name''')

        self.Label6 = tk.Label(top)
        self.Label6.place(relx=0.027, rely=0.284, height=26, width=131)
        ...
        self.Label6.configure(text='''ImageType''')

        self.Label7 = tk.Label(top)
        self.Label7.place(relx=0.027, rely=0.335, height=25, width=132)
        ...
        self.Label7.configure(text='''processed_date''')

        self.Text1 = tk.Text(top)
        self.Text1.place(relx=0.231, rely=0.077, relheight=0.043, relwidth=0.238)
        ...
        self.Text2.place(relx=0.23, rely=0.134, relheight=0.043, relwidth=0.238)
        ...
        self.Text3.place(relx=0.23, rely=0.184, relheight=0.043, relwidth=0.538)
        ...
        self.Text4.place(relx=0.23, rely=0.235, relheight=0.043, relwidth=0.539)
        ...
        self.Text6.place(relx=0.23, rely=0.284, relheight=0.043, relwidth=0.538)
        ...
        self.Scrolledwindow1.place(relx=0.023, rely=0.495, relheight=0.462
                                   , relwidth=0.64)
        ...
        self.Label8.place(relx=0.023, rely=0.433, height=36, width=553)
        ...
        self.Label8.configure(text='''Image Tags''')

        self.Label9 = tk.Label(top)
        self.Label9.place(relx=0.027, rely=0.385, height=23, width=127)
        ...
        self.Label9.configure(text='''PixelData''')

        self.Text7 = tk.Text(top)
        self.Text7.place(relx=0.23, rely=0.385, relheight=0.04, relwidth=0.543)
        ...
        self.Label10.place(relx=0.681, rely=0.433, height=31, width=263)
        self.Label10.configure(activebackground="#f9f9f9")
        self.Label10.configure(activeforeground="black")
        self.Label10.configure(background="#ffff00")
        self.Label10.configure(disabledforeground="#a3a3a3")
        self.Label10.configure(font="-family {Segoe UI} -size 14")
        self.Label10.configure(foreground="#000000")
        self.Label10.configure(highlightbackground="#d9d9d9")
        self.Label10.configure(highlightcolor="black")
        self.Label10.configure(relief="ridge")
        self.Label10.configure(text='''Comment''')

        self.Scrolledtext1 = ScrolledText(top)
        self.Scrolledtext1.place(relx=0.681, rely=0.495, relheight=0.442
                                 , relwidth=0.306)
        ...
        self.Button1.place(relx=0.855, rely=0.943, height=24, width=107)
        ...
        self.Button1.configure(text='''Save Comment''')
        self.Button1.configure(command=image_window_support.save_comment)

        self.Label11 = tk.Label(top)
        self.Label11.place(relx=0.485, rely=0.077, height=31, width=142)
        self.Label11.configure(background="#d9d9d9")
        self.Label11.configure(disabledforeground="#a3a3a3")
        self.Label11.configure(foreground="#000000")
        self.Label11.configure(relief="ridge")
        self.Label11.configure(text='''Modification time''')

        self.Text8 = tk.Text(top)
        self.Text8.place(relx=0.67, rely=0.077, relheight=0.046, relwidth=0.282)
        ...
        self.Label12.place(relx=0.485, rely=0.139, height=21, width=144)
        self.Label12.configure(background="#d9d9d9")
        self.Label12.configure(disabledforeground="#a3a3a3")
        self.Label12.configure(foreground="#000000")
        self.Label12.configure(relief="ridge")
        self.Label12.configure(text='''Modality''')

        self.Text9 = tk.Text(top)
        self.Text9.place(relx=0.67, rely=0.139, relheight=0.037, relwidth=0.282)
