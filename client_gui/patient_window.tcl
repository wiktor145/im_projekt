...
#  Jun 17, 2021 07:06:06 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top57 {base} {
    ...
    label $top.lab58 \
        ...
        -foreground #ffffff -text Patient 
    ...
    label $top.lab62 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -foreground $vTcl(actual_gui_fg) -relief ridge -text PatientID 
    vTcl:DefineAlias "$top.lab62" "Label3" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab63 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -foreground $vTcl(actual_gui_fg) -relief ridge -text PatientAge 
    vTcl:DefineAlias "$top.lab63" "Label4" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab64 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -foreground $vTcl(actual_gui_fg) -relief ridge -text PatientBirthDate 
    vTcl:DefineAlias "$top.lab64" "Label5" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab65 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -foreground $vTcl(actual_gui_fg) -relief ridge -text PatientName 
    vTcl:DefineAlias "$top.lab65" "Label6" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab66 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -foreground $vTcl(actual_gui_fg) -relief ridge -text PatientSex 
    ...
    vTcl::widgets::ttk::scrolledwindow::CreateCmd $top.scr74 \
        ...
        -height 227 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -width 604 
