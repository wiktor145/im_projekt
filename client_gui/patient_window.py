...
#    Jun 17, 2021 07:06:07 PM CEST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.geometry("782x597+398+127")
        top.minsize(120, 1)
        top.maxsize(3844, 1061)
        top.resizable(1, 1)
        top.title("Patient Window")
        top.configure(background="#f2f2f2")

        self.Label1 = tk.Label(top)
        self.Label1.place(relx=0.0, rely=0.0, height=48, width=782)
