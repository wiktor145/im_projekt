...
#  Jun 17, 2021 07:54:13 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top57 {base} {
    ...
    wm geometry $top 866x647+306+105
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl::widgets::ttk::scrolledwindow::CreateCmd $top.scr74 \
        ...
        -height 298 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -width 554 
    ...
    label $top.lab80 \
        ...
        -foreground $vTcl(actual_gui_fg) -relief ridge -text Comment 
