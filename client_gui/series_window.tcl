...
#  Jun 28, 2021 09:34:46 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top57 {base} {
    ...
    wm geometry $top 782x597+320+106
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab58 \
        ...
        -highlightcolor black -text Series 
    ...
    label $top.lab62 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -relief ridge -text SeriesInstanceUID 
    ...
    label $top.lab65 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -relief ridge -text SeriesDescription 
    ...
    label $top.lab66 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -relief ridge -text SeriesNumber 
    ...
    label $top.lab75 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -relief groove -text {Series Images} 
    ...
    place $top.tex78 \
        ...
        -height 0 -relheight 0.04 -anchor nw -bordermode ignore 
    place $top.but52 \
        -in $top -x 0 -relx 0.793 -y 0 -rely 0.084 -width 147 -relwidth 0 \
