...
from database.database_connection import MySqlDatabaseConnection
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    root = rt
    w = tk.Toplevel(root)
    dicom_repository_support.set_Tk_var()
    top = Toplevel1(w)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button3.configure(command=dicom_repository_support.open_edit_configuration)
        ...
        self.Button4.place(relx=0.053, rely=0.92, height=24, width=167)
        ...
        self.Label3.configure(text='''From date''')

        self.Label4 = tk.Label(top)
        self.Label4.place(relx=0.467, rely=0.698, height=21, width=64)
        self.Label4.configure(background="#d9d9d9")
        self.Label4.configure(disabledforeground="#a3a3a3")
        self.Label4.configure(foreground="#000000")
        self.Label4.configure(text='''To date''')

        self.Custom1 = dicom_repository_support.Custom(top)
        self.Custom1.place(relx=0.12, rely=0.733, relheight=0.066
                           , relwidth=0.139)

        self.Custom2 = dicom_repository_support.Custom(top)
